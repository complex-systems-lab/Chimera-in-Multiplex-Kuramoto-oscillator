...
ylim([0,2*pi])
writedlm("Chimera_State_Snapshot_profile.txt",x)
title("Kuramoto  oscillators : Chimera State Snapshot-Phase Plot")
plot(x,"mo",markersize=2)
savefig("Chimera_State_Snapshot_profile.png")
...
savefig("Chimera_State_Frequency_profile.png")
